...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.fourspacesRelocateWorkspace]: AuthOrchestrationOperateScope,
  [WS_METHODS.fourspacesGetOpenRouterUsage]: AuthOrchestrationReadScope,
  [WS_METHODS.fourspacesSetOpenRouterKey]: AuthOrchestrationOperateScope,
  [WS_METHODS.fourspacesClearOpenRouterKey]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledListJobs]: AuthOrchestrationReadScope,
  [WS_METHODS.scheduledCreateJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledUpdateJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledDeleteJob]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledRunJobNow]: AuthOrchestrationOperateScope,
  [WS_METHODS.scheduledListRuns]: AuthOrchestrationReadScope,
